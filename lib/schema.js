...
/**
 * `knowsAbout` is the entity's declared topical expertise.
 *
 * It is derived from the desks and services the company actually runs rather
 * than typed by hand, so it cannot drift into claiming competence in something
 * the site does not sell. Answer engines read this to decide what the
 * organisation is an authority on, which is exactly the question E-E-A-T asks.
 */
const knowsAbout = [
  ...operations.map((o) => o.title),
