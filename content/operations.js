...
import { answeringOperations } from './operations-answering.js';
import { assistantOperations } from './operations-assistant.js';
...
const baseOperations = [
  /* ====================================================================== */
  {
    ...
    headline: {
      lead: 'The visitor with a question',
      accent: 'does not come back tomorrow.',
    },
    summary:
    ...
    metaTitle: 'Outsourced Live Chat Support | Universal Virtual Support',
    metaDescription:
    ...
    intent: {
      ...
      queries: [
        ...
        '24/7 chat support for ecommerce',
    ...
    outcomes: [
      {
        title: 'Coverage matches your traffic',
        body: 'Staffed against your real traffic curve, including the evening and weekend share that currently goes unanswered.',
        measure: 'Chats answered inside the response window, by hour.',
      },
      {
        title: 'Peaks stop breaking the desk',
        body: 'The automated layer absorbs the repetitive spike, so a campaign or a season does not become a hiring problem.',
        measure: 'Response time held during peak weeks.',
      },
      {
        title: 'The channel becomes measurable',
        body: 'Volume, topic, resolution and escalation reported weekly, which turns chat from a widget into an operation.',
        measure: 'Weekly service level reporting against target.',
      },
    ],
    ...
    process: [
      {
        step: 'Volume study',
        body: 'Real conversation history — when it arrives, what it asks, what share is repetitive.',
        artifacts: [
      ...
      {
        step: 'Coverage design',
        body: 'The response window, the hours, and what happens when volume exceeds forecast.',
        artifacts: [
      ...
      {
        step: 'Knowledge build',
        body: 'The answers, the tone, and the boundaries — what the desk must never answer alone.',
        artifacts: ['Knowledge base', 'Tone guide', 'Never-answer list'],
      },
      {
        step: 'Integration',
        body: 'Access to the systems holding the answers, so the desk resolves rather than relays.',
        artifacts: [
      ...
      {
        step: 'Pilot',
        body: 'One shift pattern, monitored, with your team reviewing transcripts daily.',
        artifacts: [
      ...
      {
        step: 'Run',
        body: 'Full coverage, weekly reporting, and a standing review where the knowledge base actually changes.',
        artifacts: [
    ...
    faq: [
      {
        q: 'Are the agents dedicated to us?',
        a: 'On dedicated plans, yes — the same named people, trained on your product. Shared plans cost less and use agents covering several accounts in the same category. We recommend based on your volume rather than on margin.',
      },
      {
        q: 'How much gets handled without a person?',
        a: 'Typically half to three quarters for e-commerce and lower for technical products, and we measure it during the volume study rather than quoting an industry figure. The number is reported weekly, so you can see it rather than trust it.',
      },
      {
        q: 'What if an agent does not know the answer?',
        a: 'They escalate to your team on a rule you set, with the conversation and context attached. Escalation is treated as a knowledge gap and closed, not as an agent failure.',
      },
      {
        q: 'Which platform do you work in?',
        a: 'Yours. Intercom, Zendesk, Front, Gorgias, HubSpot, or whatever you already run — the record stays in your system so ending the arrangement does not cost you your history.',
      },
      {
        q: 'How quickly can this start?',
        a: 'Two to four weeks from the volume study, most of which is knowledge build and integration rather than recruitment.',
      },
    ],
  ...
  /* ====================================================================== */
  {
    ...
    intent: {
      primary:
        'A business losing bookings to voicemail and unable to justify a night shift.',
      queries: [
        'after hours answering service',
        'overflow call handling service',
        'how much revenue lost to missed calls',
      ],
    },
    ...
    builtFor: {
      ...
      intro:
        'Not the phone as a courtesy channel — the phone as the place the money is actually made.',
      segments: [
        {
          niche: 'home-services',
          label: 'HVAC, plumbing, roofing and restoration',
          trigger:
            'Emergency calls arrive at the worst hour and go to whoever answers first.',
          built:
            'Triage, qualification and booking against real technician availability, around the clock.',
          edge: 'Drive time and skill are modelled, so what gets booked can actually be done.',
        },
        {
          niche: 'healthcare',
          label: 'Clinics and specialty practices',
          trigger:
            'Reception is on the phone while patients wait at the desk, and recalls never go out.',
          built:
            'Booking, rescheduling, confirmations and recall campaigns, handled off your front desk.',
          edge: 'Built to the data boundary you operate under, agreed during onboarding.',
        },
        {
          niche: 'legal',
          label: 'Law firms with high intake volume',
          trigger: 'A qualified case reaching voicemail is worth nothing.',
          built:
            'Intake calls answered live, facts collected, criteria applied, case routed with the transcript attached.',
          edge: 'Collect and route only. Never advise — enforced in the script and audited.',
        },
        {
          niche: 'automotive',
          label: 'Dealership service departments',
          trigger: 'Bay capacity is perishable and booked over one line during peak hours.',
          built: 'Service booking and follow-up on quoted-but-not-booked work.',
          edge: 'Bay, technician and parts availability treated as three constraints, not one.',
        },
        {
          niche: 'logistics',
          label: 'Freight brokers and 3PL',
          trigger:
            'Check calls consume dispatcher mornings and track-and-trace comes in at all hours.',
          built:
            'Outbound check calls and inbound status handling, written straight into the TMS.',
          edge: 'Exceptions are surfaced. Only off-plan loads reach your dispatchers.',
        },
      ],
      notFor:
        'If your calls are long, consultative and unique each time, we would be learning your business on your customers. That work belongs in-house.',
    },
    ...
    solution: {
      ...
      pillars: [
        {
          title: 'Routine calls handled automatically',
          body: 'The AI layer takes the predictable share instantly, including several calls at once, so a spike does not become a queue.',
        },
        {
          title: 'Trained agents on the rest',
          body: 'Named people who know your business, taking transfers with the conversation so far already in front of them.',
        },
        {
          title: 'Booking, not messages',
          body: 'Connected to your calendar, dispatch or PMS, so the call ends in a confirmed appointment rather than a callback promise.',
        },
        {
          title: 'Everything in writing',
          body: 'Recording, transcript, extracted details and outcome in your CRM before the caller has hung up.',
        },
      ],
    },
    ...
    outcomes: [
      {
        ...
        body: 'Coverage across the hours you choose, with concurrency so simultaneous calls are all answered.',
        measure: 'Answer rate by hour, including out of hours.',
      },
      {
        title: 'Calls end in bookings',
        body: 'System access means the call completes rather than generating a callback task for the morning.',
        measure: 'Share of calls resolved on first contact.',
      },
      {
        title: 'The phone becomes a measured channel',
        body: 'Volume, reason, outcome and duration for every call — usually the first time this has been visible.',
        measure: 'Call reason and outcome, categorised.',
      },
    ],
    ...
    process: [
      {
        step: 'Call audit',
        body: 'We listen to real calls. Every failed phone operation was designed from an imagined call.',
        artifacts: [
          'Call type taxonomy from recordings',
          'Volume by hour and day',
      ...
      },
      {
        ...
        body: 'What is said, what is collected, and exactly when a call reaches a person.',
        artifacts: [
      ...
      {
        step: 'Integration',
        body: 'Calendar, dispatch, CRM and telephony connected so the call can be completed.',
        artifacts: [
      ...
      {
        step: 'Pilot',
        body: 'Out of hours first, one call type, with recordings reviewed daily.',
        artifacts: ['Pilot recordings and review', 'Transfer rate by type', 'Tuned rules'],
      },
      {
        step: 'Run',
        body: 'Full coverage with weekly reporting and monthly call quality review.',
        artifacts: ['Weekly service level report', 'Call quality scores', 'Monthly review'],
      },
    ],

    faq: [
      {
        q: 'Is it a person or an AI answering?',
        a: 'Both, by call type, and the split is agreed with you during the audit. Routine calls are handled by the AI layer instantly; anything meeting your transfer rules reaches a trained agent. The agent identifies as an agent and the AI identifies as an AI when asked — we do not build systems that claim to be human.',
      },
      {
        q: 'Can you book directly into our system?',
      ...
      {
        q: 'What does coverage cost compared to hiring?',
        a: 'We size it against your real call volume during the audit so the comparison is arithmetic. It is usually decisive for out-of-hours and overflow, and closer than people expect for full daytime coverage — we say which case yours is.',
      },
      {
        q: 'Do you handle outbound as well?',
        a: 'Yes — confirmations, recalls, check calls, follow-up on quoted work. Outbound is often where the fastest return sits, because it is work that currently does not happen at all.',
      },
      {
        q: 'What happens if your systems fail?',
        a: 'Calls fall back to your existing line automatically. The failure mode is what you have today, never a dead line.',
      },
    ],
  ...
  /* ====================================================================== */
  {
    ...
    intent: {
      primary: 'A team where support email is everyone’s job and therefore nobody’s.',
      queries: [
        'outsourced email support service',
        'shared inbox management service',
        'customer support ticket outsourcing',
      ],
    },
    ...
    builtFor: {
      ...
      intro:
        'Email persists, and that cuts both ways: an unanswered thread is evidence, and a good answer is reusable. These are the cases where the volume justifies a desk.',
      segments: [
        {
          niche: 'ecommerce',
          label: 'DTC and subscription retail',
          trigger:
            'Post-purchase email spikes with shipping incidents, exactly when order volume peaks.',
          built:
            'Order, delivery and returns handled with live commerce access and consistent refund policy application.',
          edge: 'Refund thresholds are your policy, applied identically by every agent.',
        },
        {
          niche: 'saas',
          label: 'B2B SaaS and platforms',
          trigger: 'Support email arrives with logs attached and lands on an engineer.',
          built:
            'A tier-one desk that triages, reproduces where possible, and escalates with a written diagnosis.',
          edge: 'Escalations arrive investigated, not forwarded.',
        },
        {
          niche: 'financial-services',
          label: 'Lenders, brokers and practices',
          trigger:
            'Client email carries documents, deadlines and a compliance obligation on every thread.',
          built:
            'Structured handling with documents filed correctly and deadlines tracked rather than remembered.',
          edge: 'Every thread leaves an auditable trail by construction.',
        },
        {
          niche: 'logistics',
          label: 'Freight and 3PL operators',
          trigger:
            'Track-and-trace and documentation requests arrive constantly from customers and carriers alike.',
          built:
            'Status requests answered from the TMS and documents retrieved without a dispatcher being interrupted.',
          edge: 'Answered from the system of record, not from a forwarded thread.',
        },
        {
          niche: 'education',
          label: 'Course providers and institutes',
          trigger:
            'Admissions email volume multiplies during enrolment and the same fifty questions recur.',
          built: 'Seasonal capacity with answers drawn from current, versioned policy.',
          edge: 'Policy is versioned, so an eligibility answer is never last year’s.',
        },
        {
          niche: 'fintech',
          label: 'Fintechs, neobanks and payment platforms',
      ...
      notFor:
        'If your support email is a handful of threads a day, a good template library and an hour of discipline beats outsourcing it.',
    },
      ...
      pillars: [
        {
          ...
          body: 'Every thread classified and prioritised when it lands, so ageing is a decision rather than an accident.',
        },
        {
          title: 'Drafting for the repetitive share',
          body: 'Common responses drafted from your knowledge base and live system state, reviewed and sent by an agent.',
        },
        {
          title: 'Consistency by construction',
          body: 'One knowledge base and one policy, so the answer does not depend on who opened the thread.',
        },
        {
          title: 'A target that is reported',
          body: 'First response and resolution measured against an agreed number, weekly.',
        },
      ],
    },
    ...
    outcomes: [
      {
        title: 'Response time becomes a number',
        body: 'Measured and reported against a target instead of estimated from how the inbox feels.',
        measure: 'Median and 90th-percentile first response time.',
      },
      {
        title: 'Answers stop varying',
        body: 'One knowledge base means the same question gets the same answer regardless of who handles it.',
        measure: 'Policy applied consistently across agents.',
      },
      {
        title: 'Backlogs stop forming',
        body: 'Triage prevents the ageing pattern, so a volume spike does not become a fortnight of recovery.',
        measure: 'Queue age distribution held stable through peaks.',
      },
    ],
    ...
    process: [
      {
        step: 'Inbox audit',
        body: 'Real volume, real response times, real topic distribution — usually the first honest measurement the inbox has had.',
        artifacts: [
          'Volume and response time baseline',
          'Topic taxonomy',
          'Automatable share, quantified',
        ],
      },
      {
        step: 'Knowledge build',
        body: 'The answers, the policy boundaries and the threads that must always reach your team.',
        artifacts: ['Knowledge base', 'Policy and threshold document', 'Escalation list'],
      },
      {
        step: 'Queue design',
        body: 'Classification, priority, ownership and the first-response target.',
        artifacts: ['Triage rules', 'Service level target', 'Ownership model'],
      },
      {
        step: 'Integration',
        body: 'Helpdesk, commerce and CRM access so answers come from live state.',
        artifacts: ['Helpdesk access', 'System lookups live', 'Macros and templates'],
      },
      {
        step: 'Pilot',
        body: 'A subset of queues, reviewed daily by your team.',
        artifacts: [
          'Sampled thread review',
          'Service level measured',
      ...
      {
        step: 'Run',
        body: 'Full coverage, weekly reporting, and a standing review that updates the knowledge base.',
        artifacts: ['Weekly report', 'Knowledge base updates', 'Quarterly review'],
      },
    ],

    faq: [
      {
        q: 'Do you send email as us?',
        a: 'From your domain and in your voice, yes — that is the point. Signatures and identification follow whatever policy you set; some clients name the agent, others use a team signature.',
      },
      {
        q: 'How do you keep answers consistent?',
        a: 'One knowledge base as the single source, and quality sampling on a percentage of sent threads. When two answers disagree, the knowledge base is wrong and gets fixed — that is treated as the defect rather than the agent.',
      },
      {
        q: 'What about threads needing internal knowledge?',
        a: 'They escalate on a rule you set, with a written summary of what was investigated. The aim is that your team receives a diagnosis rather than a forward.',
      },
      {
        q: 'Can you handle attachments and documents?',
        a: 'Yes — receiving, filing to the right record, and flagging what is missing. In document-heavy work that filing is often the larger share of the job.',
      },
      {
        q: 'What is a realistic response target?',
        a: 'It depends on your customers and your category. We baseline your current performance first, then agree a target that is an improvement you can afford rather than a number that sounds impressive.',
      },
    ],
  ...
  /* ====================================================================== */
  {
    ...
    title: 'Order Taking',
    headline: {
      lead: 'The order that took thirty seconds too long',
      accent: 'was placed somewhere else.',
    },
    summary:
    ...
    metaTitle: 'Order Taking Services | Universal Virtual Support',
    metaDescription:
    ...
    intent: {
      primary:
        'A business taking orders through channels that do not write to the system of record.',
      queries: [
        'outsourced order taking service',
        'phone order processing service',
        'B2B order entry outsourcing',
      ],
    },
      ...
      segments: [
        {
          ...
          edge: 'A transposed part number ships the wrong item to a production line. Validation is against real stock.',
        },
        {
          niche: 'hospitality',
          label: 'Restaurant groups and venues',
          trigger:
          ...
          edge: 'Availability is live. Nothing is taken that cannot be delivered.',
        },
        {
          niche: 'ecommerce',
          ...
          edge: 'One system of record. The spreadsheet stops existing.',
        },
        {
          niche: 'automotive',
          label: 'Parts counters and distributors',
          trigger:
          ...
          edge: 'Fitment is validated at capture, not discovered at return.',
        },
      ],
      notFor:
    ...
    solution: {
      ...
      pillars: [
        {
          title: 'Every channel, one path',
          body: 'Phone, email, chat and messaging all land in the same capture flow with the same validation.',
        },
        {
          title: 'Validated before committed',
          body: 'Stock, pricing, account terms and fitment checked at capture rather than discovered at fulfilment.',
        },
        {
          title: 'Straight into your system',
          body: 'Written into your commerce platform or ERP directly. No intermediate spreadsheet, no second entry.',
        },
        {
          title: 'Exceptions surfaced, not guessed',
          body: 'Anything ambiguous stops and reaches a person, because a confidently wrong order is expensive.',
        },
      ],
    },
    ...
    outcomes: [
      {
        title: 'Orders stop being re-keyed',
        body: 'Captured once at the point of conversation and written straight through, which removes both the delay and the transcription error.',
        measure: 'Orders entered once, at capture.',
      },
      {
        title: 'Errors are caught before fulfilment',
        body: 'Validation at capture means the wrong part is stopped at the order rather than at the return.',
        measure: 'Exception rate, and errors reaching fulfilment.',
      },
      {
        title: 'Peaks are absorbed',
        body: 'Capacity flexes with volume, so a seasonal spike does not become lost orders.',
        measure: 'Capture rate held through peak periods.',
      },
    ],
    ...
    process: [
      {
        step: 'Order flow audit',
        body: 'Every channel an order can arrive on, and what currently happens to it.',
        artifacts: [
      ...
      },
      {
        ...
        body: 'What is checked, what is refused, and what stops for a human.',
        artifacts: ['Validation rule set', 'Exception criteria', 'Pricing and terms logic'],
      },
      {
        step: 'Integration',
        body: 'Live catalogue, stock, pricing and order creation in your system.',
        artifacts: [
      ...
      {
        step: 'Agent training',
        body: 'Your products, your terminology, your accounts. Part numbers are unforgiving.',
        artifacts: ['Trained agent team', 'Product knowledge base', 'Accuracy rubric'],
      },
      {
        step: 'Pilot',
        body: 'One channel, reconciled daily against your system.',
        artifacts: ['Daily reconciliation', 'Accuracy measured', 'Rules corrected'],
      },
      {
        step: 'Run',
        body: 'All channels with daily reconciliation and weekly accuracy reporting.',
        artifacts: [
    ...
    faq: [
      {
        q: 'Can you work directly in our ERP?',
        a: 'Yes. We work in your system rather than ours, because an order that lives anywhere else has to be entered twice — which is the problem we were hired to remove.',
      },
      {
        q: 'How do you handle account-specific pricing?',
        a: 'Applied at capture from your live pricing rules, including contract pricing and volume breaks. The confirmation the customer receives is the real price.',
      },
      {
        q: 'What happens with an unusual or custom order?',
        a: 'It stops and reaches a person — yours or ours, depending on the rule. Guessing on a custom order is how the wrong thing gets manufactured.',
      },
      {
        q: 'How is accuracy measured?',
        a: 'Daily reconciliation between what was captured and what your system holds, with an error rate reported weekly and every error investigated for cause rather than logged.',
      },
      {
        q: 'Can you take orders out of hours?',
        a: 'Yes — coverage is set to your requirement. Out-of-hours capture is often the strongest case, since those orders currently do not exist at all.',
      },
    ],
  ...
  /* ====================================================================== */
  {
    ...
    title: 'B2B Sales',
    headline: {
      lead: 'Pipeline is not a volume problem.',
      accent: 'It is a follow-up problem.',
    },
    summary:
    ...
    intent: {
      primary:
        'A sales leader whose team is good at closing and inconsistent at everything before it.',
      queries: [
        'outsourced SDR service',
        'B2B lead qualification outsourcing',
      ...
      segments: [
        {
          ...
          edge: 'Driven by your order history, so the call has a reason attached.',
        },
        {
          niche: 'saas',
          label: 'B2B software and platforms',
          trigger: 'Trial signups are not qualified and demo no-shows are never chased.',
          built:
            'Qualification against your criteria, booking, and the confirmation sequence that stops no-shows.',
          edge: 'Qualification uses your criteria, not a generic scoring model.',
        },
        {
          niche: 'logistics',
          label: 'Freight brokers and 3PL',
          trigger: 'Shipper prospecting is done by whoever has a quiet afternoon.',
          built:
            'Consistent outbound against a defined list, with every conversation in the CRM.',
          edge: 'Consistency is the product. Sporadic outbound produces nothing.',
        },
        {
          niche: 'financial-services',
          label: 'Brokers and commercial lenders',
          trigger:
          ...
          edge: 'What may and may not be said is defined before the first call.',
        },
      ],
      notFor:
    ...
    solution: {
      ...
      pillars: [
        {
          title: 'Qualification against your criteria',
          body: 'Written down, applied consistently, and refined on outcomes — not improvised per rep.',
        },
        {
          title: 'Follow-up that actually runs',
          body: 'Sequenced, scheduled and completed, including the fourth attempt nobody makes.',
        },
        {
          title: 'Outbound as a routine',
          body: 'A defined list worked on a cadence, so pipeline stops being a reaction to a bad quarter.',
        },
        {
          title: 'A CRM that reflects reality',
          body: 'Every conversation logged as it happens, so the pipeline number is a measurement rather than an estimate.',
        },
      ],
    },
    ...
    outcomes: [
      {
        title: 'Follow-up stops depending on capacity',
        body: 'Sequences run to completion regardless of how busy the closers are, which is where most recovered revenue comes from.',
        measure: 'Follow-up attempts completed against the sequence.',
      },
      {
        title: 'Closers spend time closing',
        body: 'Qualification happens before the calendar invite, so sales conversations are with people who can buy.',
        measure: 'Share of booked meetings meeting qualification criteria.',
      },
      {
        title: 'The pipeline number becomes real',
        body: 'Logged as it happens rather than reconstructed on Friday, so forecasting has something to stand on.',
        measure: 'CRM completeness and recency.',
      },
    ],
    ...
    process: [
      {
        step: 'Sales process audit',
        body: 'What happens to a lead today, where they stop, and what is not being done.',
        artifacts: [
      ...
      {
        step: 'Criteria and script',
        body: 'What qualifies, what disqualifies, what is said, and the compliance boundaries.',
        artifacts: [
      ...
      },
      {
        ...
        body: 'Cadences, channels, attempt counts and what happens at the end of one.',
        artifacts: ['Sequences per lead type', 'Attempt and timing rules', 'Nurture paths'],
      },
      {
        step: 'CRM setup',
        body: 'Stages, fields and logging discipline, so the data supports a forecast.',
        artifacts: ['CRM configured', 'Logging standards', 'Reporting views'],
      },
      {
        step: 'Pilot',
        body: 'One segment, with your sales leader reviewing calls and outcomes weekly.',
        artifacts: [
      ...
      {
        step: 'Run',
        body: 'Full coverage with weekly pipeline reporting and monthly criteria review.',
        artifacts: [
    ...
    faq: [
      {
        q: 'Do you close deals?',
        a: 'No, and that is deliberate. We qualify, book and follow up; your team closes. Closing needs product depth and pricing authority that belongs inside your business.',
      },
      {
        q: 'How do you know what qualifies?',
        a: 'From your criteria, written down during onboarding and refined against outcomes. Where criteria only exist in one senior person’s head, extracting them is part of the work — and usually valuable independently of us.',
      },
      {
        q: 'Do agents work in our CRM?',
        a: 'Yes. Every call, email and outcome is logged in your system as it happens, so the pipeline is current rather than reconstructed.',
      },
      {
        q: 'What about compliance in regulated sales?',
        a: 'Boundaries are defined before the first call — what may be said, what must not, and what has to be disclosed. Calls are recorded and sampled against that standard.',
      },
      {
        q: 'How fast does outbound produce results?',
        a: 'Consistent outbound typically shows a measurable pipeline effect in the second to third month. Anyone promising results in week two is describing a list purchase.',
      },
    ],
  ...
  /* ====================================================================== */
  {
    ...
    headline: {
      lead: 'Automate the ninety percent.',
      accent: 'Staff the ten that matters.',
    },
    summary:
    ...
    intent: {
      primary:
        'An operations manager whose team spends its week re-typing documents between systems.',
      queries: [
    ...
    builtFor: {
      ...
      segments: [
        {
          niche: 'financial-services',
          label: 'Lenders, insurers and practices',
          trigger:
          ...
          edge: 'The confidence threshold is yours to set, because it is a risk decision rather than a technical one.',
        },
        {
          niche: 'logistics',
          label: 'Freight brokers and 3PL',
          trigger: 'Rate confirmations, BOLs and PODs are re-keyed into the TMS by hand.',
          built:
            'Extraction into your TMS on its terms, with exceptions surfaced rather than silently corrected.',
          edge: 'We work with the legacy interface you have.',
        },
        {
          niche: 'manufacturing',
          label: 'Manufacturers and distributors',
          ...
          edge: 'Validated against real stock. A plausible SKU is not accepted.',
        },
        {
          niche: 'healthcare',
          label: 'Clinics and practices',
          trigger: 'Intake forms are completed on paper and entered twice.',
          built: 'Digitisation and entry to the boundary your data operates under.',
          edge: 'Handled inside your boundary where the data cannot leave it.',
        },
        {
          niche: 'real-estate',
          ...
          edge: 'Criteria applied identically to every applicant, which is also a fairness property.',
        },
      ],
      notFor:
    ...
    solution: {
      ...
      pillars: [
        {
          title: 'Extraction on the bulk',
          body: 'Structured data pulled from documents with a confidence score attached to every field, not just the document.',
        },
        {
          title: 'Review below the line',
          body: 'Anything under threshold reaches a trained reviewer with the source document beside it.',
        },
        {
          title: 'Validated against your data',
          body: 'Extracted values checked against your real catalogue, account list or reference data — so a plausible wrong value fails.',
        },
        {
          title: 'A measured error rate',
          body: 'Sampled and reported, so accuracy is a number you can hold us to rather than an assumption.',
        },
      ],
    },
    ...
    outcomes: [
      {
        title: 'Your team stops transcribing',
        body: 'The bulk is handled automatically and the exceptions by reviewers, so skilled staff return to the work they were hired for.',
        measure: 'Hours returned from transcription work.',
      },
      {
        title: 'Accuracy becomes visible',
        body: 'Sampled and reported rather than assumed, which is usually the first time the real error rate has been known.',
        measure: 'Sampled accuracy rate, reported weekly.',
      },
      {
        title: 'Volume stops causing backlogs',
        body: 'Capacity flexes with document volume, so leave and seasonality stop creating queues.',
        measure: 'Turnaround time held under volume changes.',
      },
    ],
    ...
    process: [
      {
        step: 'Document study',
        body: 'Real samples across the full messy range, not the clean examples. The tail is where the cost is.',
        artifacts: [
      ...
      },
      {
        ...
        body: 'What a wrong field costs, and therefore where the confidence line belongs — set per field, not per document.',
        artifacts: [
      ...
      {
        step: 'Extraction build',
        body: 'Extraction, scoring and validation against your reference data.',
        artifacts: [
          'Extraction pipeline',
      ...
      },
      {
        ...
        body: 'Your documents, your terminology, your edge cases.',
        artifacts: ['Trained review team', 'Review guidelines', 'Quality rubric'],
      },
      {
        step: 'Parallel run',
        body: 'The new path runs alongside the existing one and the outputs are compared, which is the only honest way to measure accuracy.',
        artifacts: [
      ...
      {
        step: 'Run',
        body: 'Full volume with sampled quality assurance and weekly reporting.',
        artifacts: [
    ...
    faq: [
      {
        ...
        a: 'We measure it during the parallel run rather than quote a figure, because accuracy depends entirely on your document quality. The parallel run also measures your current manual error rate, which is the comparison that actually matters and is usually higher than expected.',
      },
      {
        q: 'Who sets the confidence threshold?',
        a: 'You do. It is a trade between review cost and error cost, and only you know what an error costs in your business. We show the curve and recommend a starting point.',
      },
      {
        q: 'What about sensitive documents?',
        a: 'Handled to your requirements, including processing inside your infrastructure where data cannot leave it. That constrains the architecture, so it is agreed during the document study rather than after.',
      },
      {
        q: 'Can you work in our systems?',
        a: 'Yes — writing into your ERP, TMS or database directly. Where the interface is a file drop or a legacy endpoint, we work with that rather than requiring you to modernise first.',
      },
      {
        q: 'What happens to documents that fail extraction?',
        a: 'They go to a reviewer with the source alongside, and the failure is categorised. Recurring failure categories drive the next round of improvement rather than being absorbed as permanent manual work.',
      },
    ],
...
/* Order sets the menu. Answering sits after the original desks so nothing that
   already existed moves position — the new cluster is additive, not a
   reorganisation. */
